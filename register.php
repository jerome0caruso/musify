<?php
    ...
    //$con is pulled from the config.php connecting to DB.  Put into account so it can be used there
			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="email2" name="email2" type="email" placeholder="e.g. jdoe@gmail.com" value="<?php getInputValue('email2') ?>" required>
					</p>
